...
public class BottomNavComponent {
    ...
    private static final By loginIconSelect = MobileBy.AccessibilityId("Login");
    ...
    public MobileElement loginIconElem(){
        return appiumDriver.findElement(loginIconSelect);
    }

    // Method 02 | Introduce main interaction method
    public void clickOnLoginIcon(){
        appiumDriver.findElement(loginIconSelect).click();
    }
}
